...
pub(super) fn end_dynamic_tool_call(&self, client: &SessionClient, event: DynamicToolCallResponseEvent) {
    let raw_output = serde_json::json!(event);
...
pub(super) fn exec_command_begin(&mut self, client: &SessionClient, event: ExecCommandBeginEvent) {
    let raw_input = serde_json::json!(&event);
...
pub(super) fn terminal_interaction(&mut self, client: &SessionClient, event: TerminalInteractionEvent) {
...
pub(super) fn start_image_generation(&mut self, client: &SessionClient, event: ImageGenerationBeginEvent) {
    let raw_input = serde_json::json!(&event);
...
pub(super) fn end_image_generation(&mut self, client: &SessionClient, event: ImageGenerationEndEvent) {
    let raw_output = serde_json::json!(&event);
...
pub(super) fn guardian_assessment(&mut self, client: &SessionClient, event: GuardianAssessmentEvent) {
